...
module.exports = {
    ...
    ChangePasswordValidator: [
        body('oldPassword').notEmpty().withMessage("mat khau cu khong duoc rong"),
        body('newPassword').notEmpty().withMessage("mat khau moi khong duoc rong").bail().isStrongPassword({
            minLength: 8,
            minLowercase: 1,
            minNumbers: 1,
            minSymbols: 1,
